...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_AzureDb_StableSamples_InstanceDateRange]
(
...
, [Leaf].[_DtuLimit] AS [Cluster_SqlServer_AzureDb_DtuLimit]
FROM
 [SightedInstances]
LEFT OUTER JOIN
(
    SELECT [Id], MAX([CollectionDate]) as [GreatestMinDate]
    FROM [data].[Cluster_SqlServer_AzureDb_StableSamples]
...
INNER JOIN
 [data].[Cluster_SqlServer_AzureDb_StableSamples] [Leaf]
