...
AS
RETURN
WITH [SightedInstances]([Id], [ParentId], [IdCollectionDate], [Cluster_Name], [Cluster_SqlServer_Name], [Cluster_SqlServer_Database_Name], [Cluster_SqlServer_Database_File_Name]) AS
(
...
, [Leaf].[_Type] AS [Cluster_SqlServer_Database_File_Type]
FROM
 [SightedInstances]
LEFT OUTER JOIN
(
