...
, [Leaf].[_AverageSecPerRead] AS [Cluster_Machine_LogicalDisk_AverageSecPerRead]
, [Leaf].[_AverageSecPerWrite] AS [Cluster_Machine_LogicalDisk_AverageSecPerWrite]
...
, [Leaf].[_FreeBytes] AS [Cluster_Machine_LogicalDisk_FreeBytes]
FROM
 [SightedInstances]
INNER JOIN
(
