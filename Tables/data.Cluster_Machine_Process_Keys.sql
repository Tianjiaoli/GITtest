...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Numerical identifier for this process (PID)', 'SCHEMA', N'data', 'TABLE', N'Cluster_Machine_Process_Keys', 'COLUMN', N'_Id'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Time the process started', 'SCHEMA', N'data', 'TABLE', N'Cluster_Machine_Process_Keys', 'COLUMN', N'_StartDate'
GO
