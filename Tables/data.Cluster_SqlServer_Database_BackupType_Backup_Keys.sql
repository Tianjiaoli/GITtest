...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Last backup of this database - start time of backup', 'SCHEMA', N'data', 'TABLE', N'Cluster_SqlServer_Database_BackupType_Backup_Keys', 'COLUMN', N'_StartDate'
GO
