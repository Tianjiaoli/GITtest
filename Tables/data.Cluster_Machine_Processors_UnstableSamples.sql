...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Number of threads in the processor queue waiting to be executed by the processor.', 'SCHEMA', N'data', 'TABLE', N'Cluster_Machine_Processors_UnstableSamples', 'COLUMN', N'_AverageQueueLength'
GO
