...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Date and time the error was logged', 'SCHEMA', N'data', 'TABLE', N'Cluster_SqlServer_Error_Keys', 'COLUMN', N'_LogDate'
GO
