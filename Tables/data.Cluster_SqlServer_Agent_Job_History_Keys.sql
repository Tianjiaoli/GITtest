...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Date & time the job started', 'SCHEMA', N'data', 'TABLE', N'Cluster_SqlServer_Agent_Job_History_Keys', 'COLUMN', N'_RunDate'
GO
