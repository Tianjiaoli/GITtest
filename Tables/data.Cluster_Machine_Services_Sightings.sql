...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Only contains a set of SQL related Services', 'SCHEMA', N'data', 'TABLE', N'Cluster_Machine_Services_Sightings', NULL, NULL
GO
