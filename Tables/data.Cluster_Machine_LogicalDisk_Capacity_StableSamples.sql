...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Total capacity of disk', 'SCHEMA', N'data', 'TABLE', N'Cluster_Machine_LogicalDisk_Capacity_StableSamples', 'COLUMN', N'_TotalBytes'
GO
