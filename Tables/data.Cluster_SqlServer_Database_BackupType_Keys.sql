...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Type of backup: full or differential', 'SCHEMA', N'data', 'TABLE', N'Cluster_SqlServer_Database_BackupType_Keys', 'COLUMN', N'_Type'
GO
