...
;
GO
EXEC sp_addextendedproperty N'MS_Description', N'Only contains a set of SQL related Services', 'SCHEMA', N'data', 'VIEW', N'Cluster_Machine_Services_StableSamples_View', NULL, NULL
GO
