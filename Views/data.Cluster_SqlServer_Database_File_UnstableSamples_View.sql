...
;
GO
EXEC sp_addextendedproperty N'MS_Description', N'Current size of database data or log file', 'SCHEMA', N'data', 'VIEW', N'Cluster_SqlServer_Database_File_UnstableSamples_View', 'COLUMN', N'Cluster_SqlServer_Database_File_Size'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Used size in file', 'SCHEMA', N'data', 'VIEW', N'Cluster_SqlServer_Database_File_UnstableSamples_View', 'COLUMN', N'Cluster_SqlServer_Database_File_UsedSize'
GO
