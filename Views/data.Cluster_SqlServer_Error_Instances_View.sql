...
;
GO
EXEC sp_addextendedproperty N'MS_Description', N'Source of the error event, such as the name of the service or the SPID', 'SCHEMA', N'data', 'VIEW', N'Cluster_SqlServer_Error_Instances_View', 'COLUMN', N'Cluster_SqlServer_Error_ProcessInfo'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Content of the error message', 'SCHEMA', N'data', 'VIEW', N'Cluster_SqlServer_Error_Instances_View', 'COLUMN', N'Cluster_SqlServer_Error_Text'
GO
