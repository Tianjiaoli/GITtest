...
;
GO
EXEC sp_addextendedproperty N'MS_Description', N'Windows process for this SQL Server instance', 'SCHEMA', N'data', 'VIEW', N'Cluster_SqlServer_Process_StableSamples_View', 'COLUMN', N'Cluster_SqlServer_Process_Id'
GO
