...
;
GO
EXEC sp_addextendedproperty N'MS_Description', N'Current bandwith of the network interface (bits per second)', 'SCHEMA', N'data', 'VIEW', N'Cluster_Machine_Network_Capacity_StableSamples_View', 'COLUMN', N'Cluster_Machine_Network_Capacity_BandwidthBitsPerSecond'
GO
