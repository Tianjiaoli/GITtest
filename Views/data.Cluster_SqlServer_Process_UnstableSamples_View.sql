...
;
GO
EXEC sp_addextendedproperty N'MS_Description', N'Current size in bytes of the memory area that the SQL Server process is utilizing', 'SCHEMA', N'data', 'VIEW', N'Cluster_SqlServer_Process_UnstableSamples_View', 'COLUMN', N'Cluster_SqlServer_Process_WorkingSet'
GO
