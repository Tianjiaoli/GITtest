...
;
GO
EXEC sp_addextendedproperty N'MS_Description', N'Free physical memory currently available on the machine', 'SCHEMA', N'data', 'VIEW', N'Cluster_Machine_Memory_UnstableSamples_View', 'COLUMN', N'Cluster_Machine_Memory_FreeBytes'
GO
